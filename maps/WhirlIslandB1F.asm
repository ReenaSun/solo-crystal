...
WhirlIslandB1FHiddenRareCandy:
	itemball RARE_CANDY, EVENT_WHIRL_ISLAND_B1F_HIDDEN_RARE_CANDY
...
WhirlIslandB1F_MapEvents:
	...
	object_event 30, 4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, WhirlIslandB1FHiddenRareCandy, EVENT_WHIRL_ISLAND_B1F_HIDDEN_RARE_CANDY