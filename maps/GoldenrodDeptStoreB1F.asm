...
GoldenrodDeptStoreB1F_MapEvents:
	...
	object_event  4,  8, SPRITE_BLACK_BELT, SPRITEMOVEDATA_SPINCOUNTERCLOCKWISE, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, GoldenrodDeptStoreB1FBlackBelt2Script, -1
