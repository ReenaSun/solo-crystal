...
GoldenrodUndergroundWarehouse_MapEvents:
	...
	object_event 12,  8, SPRITE_GENTLEMAN, SPRITEMOVEDATA_SPINCOUNTERCLOCKWISE, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodUndergroundWarehouseDirectorScript, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
