...
Route13HiddenCalcium:
	itemball CALCIUM, EVENT_ROUTE_13_HIDDEN_CALCIUM
...
Route13_MapEvents:
	...
	object_event  30,  13, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route13HiddenCalcium, EVENT_ROUTE_13_HIDDEN_CALCIUM