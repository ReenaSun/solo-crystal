...
Route44HiddenElixer:
	itemball ELIXER, EVENT_ROUTE_44_HIDDEN_ELIXER
...
Route44_MapEvents:
	...
	object_event 32,  9, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route44HiddenElixer, EVENT_ROUTE_44_HIDDEN_ELIXER