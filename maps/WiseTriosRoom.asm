...
WiseTriosRoom_MapEvents:
	...
	def_object_events
	object_event  6,  2, SPRITE_SAGE, SPRITEMOVEDATA_SPINCOUNTERCLOCKWISE, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, WiseTriosRoomSage1Script, EVENT_WISE_TRIOS_ROOM_WISE_TRIO_1
