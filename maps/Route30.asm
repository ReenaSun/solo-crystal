...
Route30HiddenPotion:
	itemball POTION, EVENT_ROUTE_30_HIDDEN_POTION
...
Route30_MapEvents:
	...
	object_event 14, 9, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route30HiddenPotion, EVENT_ROUTE_30_HIDDEN_POTION